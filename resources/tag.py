...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        #podemos comprobar manualmente si existe otra tag con el mismo store_id y el mismo nombre
...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="Returned if a tag is assigned to one or more items. It is not deleted")
